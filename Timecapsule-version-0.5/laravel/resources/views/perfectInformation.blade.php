...
<div class="container">
    <div class="row">
        ...
        <form name="PerfectInformation" method="POST" action="{{ route('perfectInformation') }}" enctype="multipart/form-data" class="col-md-4" style="margin-top:10px;">
            <!-- 419错误 -->
            @csrf

            <div class="form-group">
                <label>个人描述：</label>
                <textarea name="user[description]" class="form-control" value="{{ old('description')?old('description'):$user->description }} " rows="10">{{ $user->description }}</textarea>
            </div>
            <div class="form-group">
