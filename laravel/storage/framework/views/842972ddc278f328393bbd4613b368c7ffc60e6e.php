    ...
    <div class="row">
        ...
        <div class="col-md-8">
                ...
                <div class="diary">
                    <div class="body">
                        <div class="title">
                            ...
                            <img src="<?php echo e(asset('img/voqgt8t3.jpg')); ?>" alt="">
            ...
            <div class="notebooks">
				...
				<div class="notebook col-md-3">     
                    <a href="">
                        <img src="<?php echo e(asset('img/824299.jpg')); ?>/" alt="" class="img-thumbnail" style="width: 160px;height: 120px;">
                        日常
                    </a>
                    <p>2017-02-02 创建<br>
                    </p>
        ...
        <div class="sidebar col-md-3">
                <div class="sidebar-item">
                    ...
                    <a href=""><img src="<?php echo e(asset('img/b100192690.jpg')); ?>" alt=""></a>
                    <p style="margin-top:6px;"><?php echo e($user->created_at); ?> &nbsp加入</p>
